...
- **Examples:** Projects dashboard, counter app, voting app, team scheduling,
  people search
- **Authentication:** Flexible (can be required, optional, or allow anonymous
  access)
...
>
> Actual template code will be created when the first instance of each type is
> built. The README files define the structure and patterns to follow.
