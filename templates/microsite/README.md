...
Template for creating standalone Next.js applications for public-facing church websites.
...
1. **Create Vercel project**
   ...
   - Build command: `cd ../.. && npm run build --filter=@church/groups-microsite`
...
**Next Steps:** Build template when first microsite is needed
**Pattern:** Use similar structure to `apps/platform` but simplified for public use
