...
export default function MovementLineChart({
  labels,
  data: circleData,
  subtitle,
}: MovementLineChartProps) {
  ...
  const data = {
    ...
    datasets: dataKeys.map((key, i) => ({
      ...
      backgroundColor: `${lineColors[i]}1A`,
  ...
  return (
    <div className="text-card-foreground flex min-h-[360px] flex-col md:min-h-[520px]">
      <div className="mb-4 md:mb-6">
        <h2 className="text-base font-bold tracking-tight uppercase md:text-lg">Joined Circle</h2>
        {subtitle && (
