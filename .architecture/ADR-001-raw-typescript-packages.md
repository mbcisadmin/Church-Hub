...
Traditional approaches require build steps, watch modes, and complex tooling.
Modern bundlers (Next.js, Vite) can consume TypeScript directly.
...
**Better DX** - Edit package code, see changes immediately ✅ **Simpler
tooling** - No need to manage `tsc` configs per package ✅ **Easier
debugging** - Source maps work perfectly (no build artifact mismatch) ✅
**Reduced complexity** - Fewer moving parts in monorepo ✅ **Type safety** -
Apps get full TypeScript checking of package code
...
❌ **Package errors surface in app builds** - TypeScript errors in packages fail
app builds
