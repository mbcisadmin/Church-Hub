...
Thank you for your interest in contributing to Gospel Kit! This guide will help you get started.

## 🎯 Project Goals

Gospel Kit is a template for building church applications with MinistryPlatform. Our goals are:
...
- **Naming** - Follow MP conventions (snake_case for fields, PascalCase for types)
...
Thank you for contributing to Gospel Kit! Your work helps churches build better applications. 🙏
