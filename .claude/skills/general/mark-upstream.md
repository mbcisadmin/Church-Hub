...
Run this skill when you've fixed a bug in shared packages or core functionality
that other churches would benefit from.
...
4. **Format the entry:**
   ...
   **Details:** [User's description of the fix]
