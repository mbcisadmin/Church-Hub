...
Framework-agnostic MinistryPlatform API client for Node.js and browser environments.
...
**TypeScript enforces this requirement** - you cannot call create/update without providing a userId.
...
See TypeScript types and JSDoc comments in source code for full API documentation.
