...
@layer base {
  :root {
    ...
    --primary: 142 70% 45%; /* Woodside green #61BC47 */
    /* ... other variables */
  }
...
Components can be customized via className prop or by copying and modifying source files.
...
Internal use - Woodside Bible Church
