...
Colors use CSS custom properties for runtime theming. Define your colors in
`globals.css`:
...
The color system automatically supports dark mode via CSS variables. Define dark
mode colors in your `globals.css`:
